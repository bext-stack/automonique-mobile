...
const CONFIG = Object.freeze({
  ...
  artifactName: 'automonique-mobile-0.1.0-preview.2.apk',
  nodeVersion: '24.19.0',
  npmVersion: '11.10.1',
  ...
  commands: [
    ...
    'apkanalyzer files list automonique-mobile-0.1.0-preview.2.apk',
    'apksigner verify --verbose --print-certs automonique-mobile-0.1.0-preview.2.apk',
    ...
    'adb install --no-streaming -r automonique-mobile-0.1.0-preview.2.apk',
