 ...
 * comment-delivery lane. Check rerun is admitted only through its separate
 * capability-read/rerun/receipt grant set; the coarse execute_review_action
 * grant is not evidence that Git, CI, or pull-request adapters exist.
 */
